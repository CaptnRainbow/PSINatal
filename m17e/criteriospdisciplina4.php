                    ...
                    echo("<form method='POST'>"
                                . "<table>"
                                    . "<tr><td>");
                                        ...
                                        echo("<select id='combo' name='combocurso'>");
                                        for($i=0; $i < count($preencheCombo); $i++){
                                            echo("<option value='" . $preencheCombo[$i]["curso_fk_pk"] . "'> ". $preencheCombo[$i]["nome"] ." </option> ");
                                        }
                                        echo(" </select> ");
                                    echo("</td>");
